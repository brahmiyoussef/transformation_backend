...
/**
 * <p>Classe Java pour Field57AType complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="Field57AType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "Field57AType", propOrder = {
    "partyIdentifier",
    "identifierCode"
})
public class Field57AType {
    ...
    private static final String REGEX =
            "(\\w{0,34})";  //\s([A-Z]{0,11})
    public Field57AType parse(String input) {
        Field57AType field=new Field57AType();
