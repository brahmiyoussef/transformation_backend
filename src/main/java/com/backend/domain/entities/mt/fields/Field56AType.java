...
/**
 * <p>Classe Java pour Field56AType complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="Field56AType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "Field56AType", propOrder = {
    "partyIdentifier",
    "identifierCode"
})
public class Field56AType {
    ...
    private static final String REGEX =
            "(\\w{0,34})";  //\s([A-Z]{0,11})
    public Field56AType parse(String input) {
        Field56AType field=new Field56AType();
