...
/**
 * <p>Classe Java pour Field57DType complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="Field57DType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "Field57DType", propOrder = {
    "partyIdentifier",
    "numberAddress"
})
public class Field57DType {

    protected String partyIdentifier;
    protected String numberAddress;
    private static final String REGEX =
            "(\\w{0,34})";  //\s([A-Z]{0,11})
    public Field57DType parse(String input) {
        Field57DType field=new Field57DType();
