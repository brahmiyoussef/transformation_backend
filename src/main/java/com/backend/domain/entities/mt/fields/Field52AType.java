...
/**
 * <p>Classe Java pour Field52AType complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="Field52AType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "Field52AType", propOrder = {
    "partyIdentifier",
    "identifierCode"
})
public class Field52AType {
    ...
    private static final String REGEX =
            "(\\w{0,34})";  //\s([A-Z]{0,11})
    public Field52AType parse(String input) {
        Field52AType field=new Field52AType();
