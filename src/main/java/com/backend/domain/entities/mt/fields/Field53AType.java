...
/**
 * <p>Classe Java pour Field53AType complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="Field53AType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "Field53AType", propOrder = {
    "partyIdentifier",
    "identifierCode"
})
public class Field53AType {
    ...
    private static final String REGEX =
            "(\\w{0,34})";  //\s([A-Z]{0,11})
    public Field53AType parse(String input) {
        Field53AType field=new Field53AType();
