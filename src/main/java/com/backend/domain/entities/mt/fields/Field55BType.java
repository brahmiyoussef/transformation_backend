...
/**
 * <p>Classe Java pour Field55BType complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="Field55BType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "Field55BType", propOrder = {
    "partyIdentifier",
    "location"
})
public class Field55BType {
    ...
    private static final String REGEX =
            "(\\w{0,34})";  //\s([A-Z]{0,11})
    public Field55BType parse(String input) {
        Field55BType field=new Field55BType();
